        ...
        <section class="card-container">
            ...
            <div class="card" style="background-image: url('img/background-pro.jpg');">
                <div class="card-overlay">
                    <h3 class="title-list">Liste de tâches Pro</h3>
            ...
            </div> <!-- Fin de la carte pro -->


            <!-- Carte : Colonne des tâches personelles -->
            <div class="card" style="background-image: url('img/background-perso.jpg');">
                <div class="card-overlay">
                    <h3 class="title-list">Liste de tâches Personelles</h3>

                    <!-- Formulaire pour ajouter une nouvelle tâche -->
                    <form method="post" class="add-form">
                        <input type="text" name="task_perso" placeholder="Nouvelle tâche..." required>
